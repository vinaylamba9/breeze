...
const Toast = ({ backgroundColor, toastTitle, toastSubtitle, toastIcon, }) => {
    console.log(backgroundColor)
    return (

        <div className="flex flex-col justify-center">
            <div style={{ backgroundColor: backgroundColor }} className={`shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3`} id="static-example" role="alert" aria-live="assertive" aria-atomic="true" data-mdb-autohide="false">
                <div style={{ backgroundColor: backgroundColor, borderBottom: "1px solid grey" }} className={`flex justify-between items-center py-2 px-3 bg-clip-padding border-b  rounded-t-lg`}>
